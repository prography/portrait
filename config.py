...
parser.add_argument('--num_iters', type=int, default=100, help='number of total iterations for training D, default=200000')
parser.add_argument('--num_iters_decay', type=int, default=50, help='number of iterations for decaying lr')
