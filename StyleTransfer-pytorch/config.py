...
def get_config():
    ...
    parser.add_argument('--style_path', type=str, default='styles/vector-portrait.png')
    ...
    parser.add_argument('--sample_interval', type=int, default=1000, help="step interval to sample output image")
